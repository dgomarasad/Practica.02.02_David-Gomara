...
#el número de unidades con tres dígitos y el coste total con 8 dígitos
#enteros y 2 decimales.
producto = input('Dime el nombre del producto:')
precio = float(input('Dime el precio unitario:'))
unidades = int(input('Numero de unidades:'))
precio_total = (precio * unidades)
print('El producto {} vale {:9.2f}€, quiero {:3d} unidades y el coste total es {:11.2f}€'.format( producto, precio, unidades,precio_total))